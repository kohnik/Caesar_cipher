...
// a.innerHTML="Введите на сколько букв переместить";
// let inputNumber=document.createElement("input");
// inputNumber.className="opa";
// document.body.append(inputNumber);
// let butonOk=document.createElement("button");
// butonOk.innerHTML="ok";
// document.body.append(butonOk);
// let div=document.createElement("div");
// butonOk.addEventListener("click",GetInfo)
...
//     let inputNumber=document.querySelector(".opa").value;
//     if(input!="" && !isNaN(inputNumber))
//     {
...
//             let newNumber=item.charCodeAt(0)+Number(inputNumber);
//             if(newNumber>1103)
//             {
//                 console.log(newNumber)
//                 let zapac=newNumber-1105;
//                 str+=String.fromCharCode(1072+zapac)
//                 str=str.toLowerCase();
//             }
//             else{
//             console.log(newNumber)
//             str+=String.fromCharCode(newNumber)
//             str=str.toLowerCase();
//             }
//         });
    
//     div.textContent=`новое значение ${str}`
//     document.body.append(div);
//     }
//     else alert("вы что-то напутали")
